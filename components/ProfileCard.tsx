...
const ProfileCard: React.FC<Props> = () => {
  return (
    <div>
      ...
      <div className='dark:bg-muted bg-white w-full mb-9 rounded-2xl sm:p-4 lg:p-4'>
        ...
        <div className='flex flex-col items-center p-2'>
          ...
          <div className='text-sm leading-5 text-accent-foreground mb-4'>{CONFIG.profile.role}</div>
